...
const peticionesBackend = new PeticionesBackend('http://localhost:3000/api/v1/roles');
...
export function buscarRegistros(paginaActual) {
    ...
    const url = `http://localhost:3000/api/v1/roles?limit=${registrosPorPagina}&offset=${
...
//!  Aca se crea la tabla con sus registros
 function mostrarRegistros(resultado) {
    const tablaClientesDiv = document.querySelector('#tablaRoles');
