...
const peticionesBackend = new PeticionesBackend('http://localhost:3000/api/v1/Compra')
...
export function buscarRegistros(paginaActual) {
    ...
    const url = `http://localhost:3000/api/v1/Compra?limit=${registrosPorPagina}&offset=${
...
//!  Aca se crea la tabla con sus registros
 function mostrarRegistros(resultado) {
    const tablaCompraDiv = document.querySelector('#tablaClientes');

    // Limpiar el contenido anterior
    tablaCompraDiv.innerHTML = '';
    ...
    tablaCompraDiv.appendChild(tabla);
}
