...
function validarCliente() {
    ...
    if (telefono.value == '') {
        imprimirAlerta('El teléfono es obligatorio', divTelefono, 'Telefono');
        isValidado = false;
    ...
    if (!email_val.test(email.value) && email.value != '') {
        imprimirAlerta('El formato de gmail es incorrecto', divEmail, 'Email');
        isValidado = false;
    }

    //* Validaciones para dirección
    if (direccion.value == '') {
        imprimirAlerta('La dirección es obligatoria', divDireccion, 'Direccion');
        isValidado = false;
    }
